...
// <img class="rounded-circle" src="http://127.0.0.1:5165/wwwroot/assets/images/{{PROFILE-IMAGE}}" alt="" style="width: 30px; height: 30px;">
...
// fetch('https://localhost:7143/api/Manager/GetAllAdmins')
// .then(res => res.json())
// .then(function (value) {
